...
parser = argparse.ArgumentParser(description='Process epithelium patches.')
parser.add_argument('--input_dir', type=str, required=True, help='Input folder with images')
parser.add_argument('--output_dir', type=str, required=True, help='Folder to save processed images')
...
# Get the input folder (this will be the output_dir passed from subprocess_2.py)
input_folder = output_dir 

# Prompt the user for the output folder
output_folder = input("Enter the name of the folder where filtered images should be saved: ").strip()
...
# Process images in the input_folder (which is set by subprocess_2.py to output_dir)
